...
let rollingPaperList: [RollingPaper] = (1...116).map { RollingPaper(contentImage: "rolling_paper_\($0)", backgroundImage: BackgroundImageFormat.allCases.randomElement()!.rawValue) }
