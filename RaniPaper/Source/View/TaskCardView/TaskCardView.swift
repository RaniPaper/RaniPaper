...
struct TaskCardView_Previews: PreviewProvider {
    static var previews: some View {
        TaskCardView(viewModel: CalendarViewModel(), task: TaskModel(title: "123",deadLine: Date(), color:"ine",ticket: "우왁굳",timeInterval: .threeHourAgo), showDeleteErrorAlert: .constant(false))
    }
}
